...
-- Demonstrate that there are no duplicate Inspection IDs in the raw source data
...
SELECT COUNT(DataRaw_Inspection_ID.Inspection_ID) AS Inspection_ID_DataRaw_Duplicate
FROM DataRaw_Inspection_ID;

-- Demonstrate that there are no duplicate Inspection IDs in the cleaned data
...
SELECT COUNT(DataOpenRefine_Inspection_ID.Inspection_ID) AS Inspection_ID_DataOpenRefine_Duplicate
...
SELECT (SELECT COUNT(*) FROM DataRaw_DBA_Name) - (SELECT COUNT(*) FROM DataOpenRefine_DBA_Name) AS MergedValueCount_DBA_Name;

-- Calculate the number of DBA Name elements (cells) that were merged as inconsistent duplicates
SELECT COUNT(DOR.DBA_Name) AS MergedElementCount_DBA_Name
FROM DataOpenRefine AS DOR
...
SELECT (SELECT COUNT(*) FROM DataRaw_AKA_Name) - (SELECT COUNT(*) FROM DataOpenRefine_AKA_Name) AS MergedValueCount_AKA_Name;

-- Calculate the number of AKA Name elements (cells) that were merged as inconsistent duplicates
SELECT COUNT(DOR.AKA_Name) AS MergedElementCount_AKA_Name
FROM DataOpenRefine AS DOR
	INNER JOIN DataRaw AS DR ON DOR.Inspection_ID = DR.Inspection_ID
...
SELECT (SELECT COUNT(*) FROM DataRaw_Facility_Type) - (SELECT COUNT(*) FROM DataOpenRefine_Facility_Type) AS MergedCount_FacilityType;

-- Calculate the number of Facility Type elements (cells) that were merged as inconsistent duplicates
SELECT COUNT(DOR.Facility_Type) AS MergedElementCount_Facility_Type
FROM DataOpenRefine AS DOR
	INNER JOIN DataRaw AS DR ON DOR.Inspection_ID = DR.Inspection_ID
...
SELECT COUNT(DOR.[Address]) AS MergedElementCount_Address
FROM DataOpenRefine AS DOR
	INNER JOIN DataRaw AS DR ON DOR.Inspection_ID = DR.Inspection_ID
...
SELECT COUNT(*) AS City_DataCleaned_NULL
FROM DataOpenRefine AS DOR
...
SELECT (SELECT COUNT(*) FROM DataRaw_City) - (SELECT COUNT(*) FROM DataOpenRefine_City) AS MergedValueCount_City;

-- Calculate the number of City elements (cells) that were merged as inconsistent duplicates
SELECT COUNT(DOR.City) AS MergedElementCount_City
FROM DataOpenRefine AS DOR
	INNER JOIN DataRaw AS DR ON DOR.Inspection_ID = DR.Inspection_ID
...
SELECT COUNT(*) AS State_DataOpenRefine_NULL
FROM DataOpenRefine AS DOR
...
SELECT (SELECT COUNT(*) FROM DataRaw_Inspection_Type) - (SELECT COUNT(*) FROM DataOpenRefine_Inspection_Type) AS MergedCount_Inspection_Type;

-- Calculate the number of Inspection Type elements (cells) that were merged as inconsistent duplicates
SELECT COUNT(DOR.Inspection_Type) AS MergedElementCount_InspectionType
FROM DataOpenRefine AS DOR
	INNER JOIN DataRaw AS DR ON DOR.Inspection_ID = DR.Inspection_ID
...
SELECT COUNT(DataRaw_InspectionViolation.ViolationID) AS Violations_DataRaw_Count
...
SELECT COUNT(*) AS Violations_DataOpenRefine_Count
